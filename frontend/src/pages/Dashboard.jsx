      ...
      <main className="max-w-5xl mx-auto p-6 w-full flex-1">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {groups.length === 0 ? (
              <div className="col-span-full flex flex-col items-center justify-center text-center py-24 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm daisy-card">
