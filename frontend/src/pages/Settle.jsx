    ...
    <div className="min-h-screen flex flex-col page-enter">
      ...
      <main className="max-w-5xl mx-auto p-6 w-full flex-1">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Settle Up</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {youOwe.map((b) => (
                    <li key={`owe-${b.toUserId}`} className="flex justify-between items-center bg-rose-50/50 p-3 rounded-lg border border-rose-100">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-extrabold text-rose-600">${b.amount.toFixed(2)}</span>
                ...
                <ul className="space-y-3">
                  {oweYou.map((b) => (
                    <li key={`owed-${b.fromUserId}`} className="flex justify-between items-center bg-emerald-50/50 p-3 rounded-lg border border-emerald-100">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-extrabold text-emerald-600">${b.amount.toFixed(2)}</span>
          ...
          <Card className="p-8 h-fit">
            <h2 className="text-2xl font-extrabold mb-6 text-gray-900">Record a Payment</h2>
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-10 pr-4 py-3 bg-white/50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500/30 text-2xl font-bold"
                    required
                  />
                </div>
              </div>
