      ...
      <main className="max-w-6xl mx-auto p-6 w-full flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="animate-slide-up">
          ...
          <Card className="p-0 overflow-hidden border-0 shadow-2xl rounded-3xl relative">
            ...
            <div className="p-8 pt-6 bg-gray-50 rounded-b-3xl">
              <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
                <div>
                  <p className="text-sm text-gray-500 font-medium mb-1">Paid by</p>
                  <p className="font-bold text-gray-900 text-lg flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center text-xs shadow-[inset_0_1px_1px_rgba(255,255,255,0.5)]">
              ...
              <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Split Breakdown</h3>
        ...
        <Card className="flex flex-col h-[650px]" animate={false}>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-100/50">
            {expense.comments.length === 0 ? (
              ...
              expense.comments.map(comment => (
                <div key={comment.id} className="bg-gray-50 p-4 rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] border border-gray-200 animate-fade-in">
          ...
          <form onSubmit={handleAddComment} className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white border border-gray-200 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/30 transition-all shadow-[inset_0_1px_2px_rgba(0,0,0,0.05)] dark:bg-slate-700 dark:text-white"
